...
from .views import news_detail, ContactPageView, news_List, HomePageView, MahalliyNewsView, XorijiyNewsView, \
    TexnoNewsView, SportNewsView, NewsUpdateView, NewsDeleteView, NewsCreateView, admin_page_view
